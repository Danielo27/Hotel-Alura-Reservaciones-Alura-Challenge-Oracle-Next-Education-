...
public class RegistroHuesped extends JFrame {
    ...
    ///GETTERS AND SETTERS BOOKING
    public void setBooking(Integer booking) {
        this.idBooking = booking;
        txtNreserva.setText(booking.toString(booking));
    }
    ...
    public RegistroHuesped() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(RegistroHuesped.class.getResource("../image/lOGO-50PX.png")));
        ...
        txtFechaN.getCalendarButton().setIcon(new ImageIcon(RegistroHuesped.class.getResource("../image/icon-reservas.png")));
        ...
        btnguardar.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                //PROCESSING DATA OF FORM
                String name = txtNombre.getText();
                String surname = txtApellido.getText();
                Date bornDate = txtFechaN.getDate();
                ...
                if (getBooking() != null) {
                    if (name != null && surname != null && bornDate != null && nacionality != null && phoneNumber != null) {
                        guestController saveGuest = new guestController();

                        DateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
                        String newBornDate = formatter.format(bornDate);
                        Integer response = saveGuest.setGuest(name, surname, newBornDate, nacionality, phoneNumber, idBooking);
                        if (response > 0) {
                            try {
                    ...
                    JOptionPane.showMessageDialog(null, "SU RESERVA NO PUEDE SER COMPLETADA; NUMERO DE RESERVA INVALIDO");
                }
        ...
        imagenFondo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("../image/registro.png")));

        JLabel logo = new JLabel("");
        logo.setBounds(194, 39, 104, 107);
        panel.add(logo);
        logo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("../image/Ha-100px.png")));
