...
public class ReservasView extends JFrame {
    ...
    public ReservasView() {
        super("Reserva");
        setIconImage(Toolkit.getDefaultToolkit().getImage(ReservasView.class.getResource("../image/aH-40px.png")));
        ...
        txtFechaE.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("../image/icon-reservas.png")));
        ...
        txtFechaS.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("../image/icon-reservas.png")));
        ...
        txtFechaS.addPropertyChangeListener(new PropertyChangeListener() {
            public void propertyChange(PropertyChangeEvent evt) {
                ...
                if (ReservasView.txtFechaE.getDate() != null && ReservasView.txtFechaS.getDate() != null) {
                    ...
                    String firstDate = formatter.format(ReservasView.txtFechaE.getDate());
                    String lastDate = formatter.format(ReservasView.txtFechaS.getDate());
                    calculateBookingValue(firstDate, lastDate);
                }
        ...
        panel_1.add(logo);
        logo.setIcon(new ImageIcon(ReservasView.class.getResource("../image/Ha-100px.png")));

        JLabel imagenFondo = new JLabel("");
        imagenFondo.setBounds(0, 140, 500, 409);
        panel_1.add(imagenFondo);
        imagenFondo.setBackground(Color.WHITE);
        imagenFondo.setIcon(new ImageIcon(ReservasView.class.getResource("../image/reservas-img-3.png")));
        ...
        btnsiguiente.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (ReservasView.txtFechaE.getDate() != null && ReservasView.txtFechaS.getDate() != null) {
                    ...
                    String firstDate = formatter.format(ReservasView.txtFechaE.getDate());
                    String lastDate = formatter.format(ReservasView.txtFechaS.getDate());
                    String wayPay = ReservasView.txtFormaPago.getSelectedItem().toString();
                    
                    bookingController booking = new bookingController();
                    int value = Integer.parseInt(ReservasView.txtValor.getText());
                    

                    int IdBooking = booking.setBooking(firstDate, lastDate, value, wayPay);
                    RegistroHuesped registro = new RegistroHuesped();
                    registro.setBooking(IdBooking);
    ...
    private int calculateBookingValue(String firstDate, String lastDay) {
        ...
        try {
            firstDateIn = format.parse(firstDate);
            lastDateIn = format.parse(lastDay);
        } catch (ParseException e) {
            throw new RuntimeException(e);
        }

        int miliSecondsByDay = 86400000;
        int days = (int) ((lastDateIn.getTime() - firstDateIn.getTime() / miliSecondsByDay));
        int bookingValue = ((int) days) * pricePerDay;
        ReservasView.txtValor.setText(String.valueOf(bookingValue));
        return bookingValue;
    }
