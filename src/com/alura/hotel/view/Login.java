...
public class Login extends JFrame {
	...
	public Login() {
		...
		imgHotel.setIcon(new ImageIcon(Login.class.getResource("../image/img-hotel-login-.png")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(Login.class.getResource("../image/lOGO-50PX.png")));
	...
	private void Login() {
	        ...
	        String inContrase=new String (txtContrasena.getPassword());
                String inUsuario = new String (txtUsuario.getText()); 
               
	        if(new userController().login(inContrase, inUsuario) != 0){
