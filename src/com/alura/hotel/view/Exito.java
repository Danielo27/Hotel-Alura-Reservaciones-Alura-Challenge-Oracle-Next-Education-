...
public class Exito extends JDialog {
	 ...
	 */
	public Exito() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Exito.class.getResource("../image/aH-40px.png")));
		...
		contentPanel.setLayout(null);
		{
			...
			lblNewLabel.setIcon(new ImageIcon(Exito.class.getResource("../image/Ha-100px.png")));
